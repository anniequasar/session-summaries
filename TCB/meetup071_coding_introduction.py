# -*- coding: utf-8 -*-
"""meetup071_coding_introduction.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1UU-KS3EGgmyYlyVLRFN3HWgZbqR0qUeg
...
Jupyter Notebooks are an extension of IPython (Interactive Python). Every exercise could also be done in Python. Python version of this notebook available in https://github.com/anniequasar/session-summaries/TCB
