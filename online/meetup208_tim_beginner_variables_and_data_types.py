#!/usr/bin/env python3
r"""MeetUp 208 - Beginners' Python and Machine Learning - 04 Sep 2024 - Getting Started 1
...
Links:
- Colab:   https://colab.research.google.com/drive/1YHwUv7bmum-xlqr2nw0BzIomsJ6i_CD5
- Youtube: https://youtu.be/9j1SePU5qI8
- Meetup:  https://www.meetup.com/beginners-python-machine-learning/events/302949572/
...
- Use a Google account to go to https://colab.research.google.com
 ...
 - Currently uses Python 3.10.12
- Install Python 3.12.5 from https://www.python.org/downloads/
...
- PyCharm Community Edition 2024.2 from https://www.jetbrains.com/pycharm/download/
