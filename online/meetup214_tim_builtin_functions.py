#! /usr/bin/env python3
r"""MeetUp 214 - Beginners' Python and Machine Learning - 28 May 2025 - Built-in functions
...
Links:
- Colab:   https://colab.research.google.com/drive/1WeyHkis1GsaFbKzI6LnslYCMZd2EvWBv
- Youtube: https://youtu.be/aW3GimDtmYE
- Meetup:  https://www.meetup.com/Beginners-Python-Machine-Learning/events/307798293/
...
# use map with zip to create a new dict
