...
- Install Python 3.10.0 from https://www.python.org/downloads/
...
- Integrated Development Environment (IDE), easier to write programs
 - PyCharm Community Edition 2021.2.3 from https://www.jetbrains.com/pycharm/download/
...
print("Beginners' Python And Machine Learning 127")
