...
- Use a Google account to go to https://colab.research.google.com
 ...
 - Currently uses Python 3.7.12
- Install Python 3.10.2 from https://www.python.org/downloads/
...
- PyCharm Community Edition 2021.3.1 from https://www.jetbrains.com/pycharm/download/
