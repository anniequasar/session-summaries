#!/usr/bin/env python3
r"""MeetUp 205 - Beginners' Python and Machine Learning - 03 Jul 2024 - Functions introduction
...
Links:
- Colab:   https://colab.research.google.com/drive/1kXASwwRx0kiWPNiRg4vrGlW3jP-jZh8i
- Youtube: https://youtu.be/JCQaUFw7-7M
- Meetup:  https://www.meetup.com/beginners-python-machine-learning/events/301480679/
...
- Install Python 3.12.3 from https://www.python.org/downloads/
...
- Integrated Development Environment (IDE), easier to write programs
 - PyCharm Community Edition 2024.1.2 from https://www.jetbrains.com/pycharm/download/
...
print("Beginners' Python And Machine Learning 205")
