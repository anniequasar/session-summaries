#!/usr/bin/env python3
r"""MeetUp 195 - Beginners' Python and Machine Learning - 17 Jan 2024 - Creating spreadsheets from Python
...
# Run script
#     python online/meetup195_tim_creating_spreadsheets.py  # Linux or MacOS
#     python online\meetup195_tim_creating_spreadsheets.py  # Windows
