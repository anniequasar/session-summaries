#!/usr/bin/env python3
"""MeetUp 071 - Beginners' Python and Machine Learning - 03 Aug 2020 - Getting Started 3

Youtube: https://youtu.be/AmCeHuCW0kw
Colab:   https://colab.research.google.com/drive/1UU-KS3EGgmyYlyVLRFN3HWgZbqR0qUeg
Github:  https://github.com/timcu/bpaml-sessions/tree/master/online
MeetUp:  https://www.meetup.com/beginners-python-machine-learning/events/272140761/
...
- PyCharm Community Edition 2020.1.2 from https://www.jetbrains.com/pycharm/download/
...
Jupyter Notebooks are an extension of IPython (Interactive Python). Every exercise could also be done in Python.
Python version of this notebook available in https://github.com/timcu/bpaml-sessions/online

Jupyter Notebooks are a great way to learn because you see the results immediately. They can also be great for data science.
However, they are not suited for some Python programs such as web applications, database apps, desktop apps, GUI apps,
...
"""
# import statements allow us to use standard and third-party libraries
# they should be at beginning of file
import datetime
import pytz
...
# lists can be created using loop
...
# Task 6: Rewrite the following examples of range using a loop
