#!/usr/bin/env python3
"""MeetUp 181 - Beginners' Python and Machine Learning - Wed 19 Apr 2023 - PDF
...
Requirements: (add to requirements.txt from meetup177)
reportlab
...
from meetup177_tim_email import send_message_via_gmail, message_from_str
...
mkdir bpaml177
cd bpaml177
# Copy this file and last month's file into that directory
# meetup177_tim_email.py
# meetup181_tim_pdf.py
"""
...
# For emailing details see session 177
...
# More about the canvas https://docs.reportlab.com/reportlab/userguide/ch2_graphics/#more-about-the-canvas
# Drawing operations    https://docs.reportlab.com/reportlab/userguide/ch2_graphics/#drawing-operations
def pdf_demo_7(file):
...
# https://docs.reportlab.com/reportlab/userguide/ch2_graphics/#the-toolbox-the-state-change-operations
# Colors
# https://docs.reportlab.com/reportlab/userguide/ch2_graphics/#colors
def pdf_demo_8(file):
    c = Canvas(file, pagesize=A4)
...
# https://docs.reportlab.com/reportlab/userguide/ch2_graphics/#standard-fonts-and-text-objects
def pdf_demo_9(file):
    c = Canvas(file, pagesize=A4)
    x, y = 50 * mm, 280 * mm
...
# Text object methods
# https://docs.reportlab.com/reportlab/userguide/ch2_graphics/#text-object-methods
...
# Paragraphs https://docs.reportlab.com/reportlab/userguide/ch6_paragraphs/
# Preformatted https://docs.reportlab.com/reportlab/userguide/ch9_other_useful_flowables/
# Spacer https://docs.reportlab.com/reportlab/userguide/ch9_other_useful_flowables/#spacerwidth-height
# ListFlowable, ListItem https://docs.reportlab.com/reportlab/userguide/ch9_other_useful_flowables/#listflowablelistitem
# BalancedColumns https://docs.reportlab.com/reportlab/userguide/ch9_other_useful_flowables/#balancedcolumns
...
# Tables and TableStyles https://docs.reportlab.com/reportlab/userguide/ch7_tables/
# from reportlab.platypus import Table
# from reportlab.pdfbase import pdfmetrics
# from reportlab.pdfbase.ttfonts import TTFont, TTFError
...
# TrueType font support https://docs.reportlab.com/reportlab/userguide/ch3_fonts/#truetype-font-support
