#!/usr/bin/env python3
"""MeetUp 067 - Beginners' Python and Machine Learning - 07 Jul 2020 - Getting Started 1

Youtube: https://youtu.be/U1nowb04PPk
Colab:   https://colab.research.google.com/drive/1ovg_WAnSgJpcygUsK1zvU8JMnyIJmjxL
Github:  https://github.com/timcu/bpaml-sessions/tree/master/online
MeetUp:  https://www.meetup.com/beginners-python-machine-learning/events/271727750/
...
print(f"[2, 6] not in [5, 1, 2, 6] returns {[2, 6] not in [5, 1, 2, 6] } because "
      "only one element of a list can be checked with 'in' at a time")
...
lst_keywords_covered = ['False', 'None', 'True', 'and', 'elif', 'else', 'for', 'if', 'import', 'in', 'is', 'not',
                        'or', 'pass', 'while']
