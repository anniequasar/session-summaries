#!/usr/bin/env python3
"""MeetUp 114 - Beginners' Python and Machine Learning - 07 Sep 2021 - Getting Started 1

Youtube: https://youtu.be/e71u4zRhU3Y
Colab:   https://colab.research.google.com/drive/1djLYxg8ZYf2sKUWhRKTWdEpQjVQa2pWB
Meetup:  https://www.meetup.com/Beginners-Python-Machine-Learning/events/280459386/
...
- PyCharm Community Edition 2021.2 from https://www.jetbrains.com/pycharm/download/
...
# Python 3.8 has 35 keywords, adding 'async' and 'await' to the list from Python 3.7
