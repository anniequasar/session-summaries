#! /usr/bin/env python3
r"""MeetUp 136 - Beginners' Python and Machine Learning - 01 Mar 2022 - Getting Started 2
...
Links:
- Colab:   https://colab.research.google.com/drive/1jjJ4uk01pYfWh6VOq46qenqSxox66OMH
- Youtube: https://youtu.be/gDBzy9Xk68o
- Meetup:  https://www.meetup.com/Beginners-Python-Machine-Learning/events/284185108
...
It is the second in the series targeted at absolute beginners after meetup 132.
...
# How to determine which version of Python by using the standard library called sys
print(f"{sys.version=}")

# How to run shell commands in Google Colab's underlying linux operating system (Remove the # at front of line)
# !uname -a
# !lsb_release -a
