...
Links
- Colab: <https://colab.research.google.com/drive/1gNKrAowEbzNM0zFjLRdo0nOyP2nf8yrX>
- Youtube: <https://youtu.be/zOj18jk0RxA>
...
print("Solution 4")
print(f"{grouped_symbols=}")
print(f"{name_stems=}")
print(f"{name_variants=}")
print(f"{name_symbols=}")
print(f"{num_symbols=}")
