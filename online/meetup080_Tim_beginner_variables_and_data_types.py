#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""meetup080_Tim_beginner_variables_and_data_types.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1zomyGmpSBFX_opshc_vo72EYgowKSaIN
...
print(f"del s[2] returns TypeError: 'str' object doesn't support item deletion")
...
print(f"keywords covered {len(['False', 'None', 'True', 'and', 'as', 'del', 'elif', 'else', 'for', 'from', 'if', 'import', 'in', 'is', 'not', 'or', 'pass', 'while'])}")
