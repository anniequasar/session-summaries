#!/usr/bin/env python3
r"""MeetUp 221 - Beginners' Python and Machine Learning - 03 Sep 2024 - Beginner variables and data types
...
Links:
- Colab:   <https://colab.research.google.com/drive/1Unksm2k0YV2_7YV1zPrej87INt0cNZrr>
- Youtube: <https://youtu.be/bRoupOgHllE>
- Meetup:  <https://www.meetup.com/beginners-python-machine-learning/events/310610316/>
...
- Use a Google account to go to https://colab.research.google.com
  ...
  - Colab currently uses Python 3.12.11
- Install Python 3.13.7 from https://www.python.org/downloads/
...
- PyCharm Community Edition 2025.2 from https://www.jetbrains.com/pycharm/download/
...
print(f"f-strings can also evaluate expressions and display expression and result with '=' {2*c=}")
...
# The previous two lines are commented because they require third party libraries installed

# keywords covered above
lst_keywords_covered = 'False|None|True|and|as|del|for|from|import|in|is|not|or|pass'.split('|')
