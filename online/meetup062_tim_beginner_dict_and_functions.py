...
print("Recap: How to store different data types in variables")
my_int = 5
my_float = 5.
my_bool = True
...
# How to display contents of variable in Interactive Python or Python Console
# my_list
...
print("\nDeleting values from end of list")
del(numbers[-3:])
print(numbers)
print()
...
print("Examples of built-in functions with positional arguments")
...
print("Methods are functions attached to classes.")
...
print("Examples of unpacking positional arguments ")
list_args = ['\t', 4]
...
unnamed(4, 'foobar')
# unnamed(count=4, text='foobar')  # fails

# ** notation can also be used to unpack named arguments from mapping eg dict
print("Examples of unpacking positional arguments ")
my_kw_args = {'maxsplit': 3, 'sep': '\t'}
tsv = "first one\tsecond\t3rd\t4th\t5th\t6th"
print(f"tsv           : {tsv}\nmy_kw_args    : {my_kw_args}")
print(f"tsv.split(**my_kw_args) : {tsv.split(**my_kw_args)}")
...
print("Example of unpacking named arguments 'def named(**kwargs)'")
